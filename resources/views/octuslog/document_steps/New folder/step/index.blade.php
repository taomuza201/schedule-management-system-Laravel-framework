            ...
            <div class="col-sm-12 col-md-12col-xl-12  ">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i>จัดการข้อมูลขั้นตอนกาารทำเอกสาร</div>
                    <div class="card-body">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{route('document_steps.store')}}" id="form_modal">
                                            ...
                                            <input type="hidden" value="{{$id}}" name="document_types_id">
                        ...
                        <table class="table table-responsive-sm table-striped table-bordered" id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="no_number"  data-href="{{ url('document_steps_details/'.$row->document_steps_id ) }}"></td>
                                    <td  data-href="{{ url('document_steps_details/'.$row->document_steps_id ) }}">{{ $row->document_steps_name }}</td>
