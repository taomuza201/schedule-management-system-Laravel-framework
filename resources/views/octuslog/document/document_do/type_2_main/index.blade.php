                        ...
                        <div class="card-body">
                            ...
                            <form action="type_1" method="post" id="myFormId">
                                ...
                                <textarea class="form-control mt-3 mb-3" id="text_part_2" name="text_part_2" rows="3"
                                    placeholder="ส่วนที่ 2...">ในการนี้ โครงการยกระดับเศรษฐกิจและสังคมรายตำบลแบบบูรณาการ&nbsp;{{$document_title->districts_name}}&nbsp;ขออนุญาตเดินทางไปราชการเพื่อจัดกิจกรรมติดตามการดำเนินงานโครงการหลัก ในวันที่ </textarea>
                                <div class="row">
